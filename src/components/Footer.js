            ...
            <Container textAlign='center'>
                <Grid inverted>
                    <Grid.Row>
                        ...
                        <p style={{ color: '#f5f7f8' }}><a href='https://www.linkedin.com/company/lighthouse-reports/' target="_blank" className={"socialicon"}>Lighthouse Reports</a> is an investigative nonprofit newsroom working with Europe’s leading media.</p>
                        </Grid.Column>
                    </Grid.Row>
                    <Grid.Row>
