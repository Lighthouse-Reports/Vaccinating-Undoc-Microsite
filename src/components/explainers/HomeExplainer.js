...
const HomeExplainer = (props) => {
  ...
  return (
    ...
    >
      <Modal.Header><h1 className={"mainTitle"}>The Barriers to Vaccine Access</h1></Modal.Header>
      <Modal.Content  scrolling>
        ...
        <img 
          src="https://rawcdn.githack.com/Lighthouse-Reports/Vaccinating-Undoc-Microsite/26fbb686dced24081d9e032c67ad93eea372ba0a/public/images/hexmap.png"
          width="100%"
        />
        ...
        <h3>A Grim Picture For Vaccine Access</h3>
        <br />
        <p>
