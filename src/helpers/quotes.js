...
const quotesRawWithoutIdEL = [
  {
    ...
    "RangeEquivalent": "-",
    "Comment": "«Άτομα χωρίς έγγραφα έχουν αποκλειστεί μέχρι στιγμής από τις προσπάθειες εμβολιασμού, αν και θεωρητικά μπορούν να έχουν πρόσβαση στα εμβόλια για την COVID-19»",
  ...
  },
  {
    "Country": "Greece",
    "Category": "Uncategorised",
    "CategoryDetail": "Τοπικές διαφορές",
  ...
  },
  {
    ...
    "Category": "Privacy Guarantees",
    "CategoryDetail": "",
    "Question": "Κατά τη γνώμη σας, υπάρχουν αρκετές εγγυήσεις προστασίας απορρήτου / εμπιστευτικότητας στις προσπάθειες εμβολιασμού κατά της COVID-19 για να διασφαλιστεί ότι τα άτομα χωρίς έγγραφα δεν διστάζουν να κάνουν το εμβόλιο από φόβο μήπως καταγγελθούν ή απελαθούν;",
    ...
    "RangeEquivalent": "-",
    "Comment": "«Σε ορισμένες περιπτώσεις, σε μικρές πόλεις και χωριά, οι κατά τόπο κυβερνώντες κάλεσαν την αστυνομία όταν εμφανίστηκαν άτομα χωρίς έγγραφα και ρωτούσαν πού και πώς μπορούσαν να εμβολιαστούν»",
    "PersonName": "Ρέα-Νεφέλη Τζανετάκου",
    "PersonQualification": "Συντονίστρια Εκστρατείας, Intersos Hellas (Ελλάδα)",
    "PersonBio": "Η Ρέα-Νεφέλη Τζανετάκου είναι Ελληνίδα δημοσιογράφος και ανθρωπολόγος. Εργάστηκε για περισσότερα από 10 χρόνια σε διάφορα ΜΜΕ και στη συνέχεια απασχολήθηκε στον ανθρωπιστικό τομέα."
  },
  {
    "Country": "Greece",
    "Category": "Uncategorised",
    "CategoryDetail": "Πρόσβαση στα εμβόλια έναντι πρόσβασης στην υγειονομική περίθαλψη",
