...
const questionsEL = [
  ...
  },
  {
    ...
    "Range Max": "Διαφανής",
    "Range Min": "Αδιαφανής",
    "Yes": "Ναι, οι εθνικές αρχές έχουν εξηγήσει τις πολιτικές εμβολιασμού μέσω δημόσιων δηλώσεων, δηλώσεων, δεσμεύσεων",
  ...
  },
  {
    ...
    "NA": "Μη διαθέσιμος. Δεν εντοπίστηκε κατάλογος των συμμετεχόντων στην εθνική στρατηγική εμβολιασμού",
    "Unknown": "Άγνωστο. Υπάρχει ένας κατάλογος υπευθύνων αλλά δεν είναι ξεκάθαρο ποιοί είναι ή ποιους εκπροσωπούν (η λίστα δεν περιλαμβάνει τέτοιες πληροφορίες)",
    "Yes_Score": 1,
    "No_Score": -1,
    "NA_Score": -2,
    "Unknown_Score": -0.5
  ...
  },
  {
    ...
    "NA": "-",
    "Unknown": "Άγνωστο. Δεν μπορεί να προσδιοριστεί από τα εθνικά έγγραφα εμβολιασμού εάν ο ίδιος τύπος ή επιλογή εμβολίου είναι διαθέσιμος σε άτομα χωρίς έγγραφα όπως και για εγγεγραμμένους κατοίκους",
    "Yes_Score": 1,
    "No_Score": -1,
    "NA_Score": -2,
    "Unknown_Score": -0.5
  },
  {
    ...
    "Range Max": "Διαφανής",
    "Range Min": "Αδιαφανής",
    "Yes": "Ναι, τα εθνικά έγγραφα εμβολιασμού αναφέρουν ποιες απαιτήσεις ταυτοποίησης είναι απαραίτητες για τον εμβολιασμό",
    "No": "Όχι, τα εθνικά έγγραφα εμβολιασμού αναφέρουν ποιες απαιτήσεις ταυτότητας είναι απαραίτητες για τον εμβολιασμό",
    "NA": "-",
    "Unknown": "-",
    "Yes_Score": 1,
    "No_Score": -1,
  ...
  },
  {
    ...
    "Range Max": "Ανοιχτή και Προσβάσιμη",
    "Range Min": "Κλειστή",
    "Yes": "Ναι, συγκεκριμένα προγράμματα, όπως «Συχνές Ερωτήσεις», συνεδρίες ενημέρωσης της κοινότητας και ενημερωτικό υλικό που διανέμεται ονλάιν ή εκτός διαδικτύου με σκοπό την αντιμετώπιση της παραπληροφόρησης και της επιφυλακτικότητας απέναντι στον εμβολιασμό",
